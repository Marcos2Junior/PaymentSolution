...
namespace PaymentSolution.Application.Services.AuthenticationServices.GerenciaNet
{
    public class GerenciaNetAuthentication
    {
        ...
        public GerenciaNetAuthentication(ILogger<GerenciaNetAuthentication> logger, HttpClient httpClient, IAuthenticationService authenticationService, IPaymentServiceService paymentServiceService)
        {
